    ...
    <div className="min-h-screen bg-background text-foreground overflow-hidden">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            {[
              ...
              >
                ...
                <p className="text-2xl md:text-3xl font-black">{stat.value}{stat.suffix}</p>
      ...
      <section id="curriculum" className="relative py-24">
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-5">
            <ModuleCard icon={Settings} title="Account Setup & Verification" delay={0} items={["Adobe Stock Contributor", "Shutterstock Contributor", "Freepik Contributor", "VectorStock, Dreamstime, Depositphotos", "Professional Profile Setup", "Verification Process"]} />
            <ModuleCard icon={Shield} title="Marketplace Rules & Growth" delay={0.1} items={["Marketplace Guidelines", "Account Safety Practices", "Approval Rate বৃদ্ধির কৌশল", "Rejection কমানোর Best Practices", "Download Potential বাড়ানোর Workflow", "Marketplace Growth Strategy"]} />
            <ModuleCard icon={Search} title="Niche Research" delay={0.2} items={["High Demand Niches", "Evergreen Niches", "Seasonal Niches", "Commercial Niches", "Ethical & Halal Niches"]} />
            <ModuleCard icon={Palette} title="Design & Asset Creation" delay={0.3} gradient="from-blue-500/15 to-blue-500/5" items={["Adobe Illustrator: Vector, Icon, Pattern", "AI Vector Creation", "AI Image & PNG Creation", "Vectorization & Upscaling", "Background Removal"]} />
            <ModuleCard icon={Layers} title="Advanced Workflow" delay={0.4} gradient="from-purple-500/15 to-purple-500/5" items={["Stock Video Creation", "Metadata SEO & Keyword Research", "Upload Workflow", "Asset Optimization", "Illustrator Automation"]} />
            <ModuleCard icon={Gift} title="Included Resources" delay={0.5} gradient="from-green-500/15 to-green-500/5" items={["✅ Metadata Generator", "✅ AI Prompt Generator", "✅ Background Removal Resource", "✅ Vector Workflow Resource", "✅ Upload Workflow Resource"]} />
          </div>
        </div>
      </section>
      ...
      <section id="faq" className="relative py-24">
        <div className="max-w-3xl mx-auto px-4">
          ...
          <Accordion type="single" collapsible className="space-y-3">
            {[
              { q: "এই কোর্সের জন্য কি পূর্ব অভিজ্ঞতা প্রয়োজন?", a: "না, পূর্ব অভিজ্ঞতার প্রয়োজন নেই। আমরা বেসিক থেকে শুরু করে অ্যাডভান্সড লেভেল পর্যন্ত সবকিছু শেখাবো। শুধু শেখার আগ্রহ এবং কাজ করার মানসিকতা থাকলেই হবে।" },
              { q: "কি কি সরঞ্জাম প্রয়োজন?", a: "একটি PC বা Laptop এবং Internet Connection থাকলেই চলবে। সমস্ত সফটওয়্যার এবং টুলস সম্পর্কে আমরা কোর্সের মধ্যেই বিস্তারিত গাইডলাইন দেব।" },
              { q: "ক্লাসের সময় কেমন হবে?", a: "সপ্তাহে ২টি লাইভ ক্লাস হবে। প্রতিটি ক্লাসের রেকর্ডিং সংরক্ষিত থাকবে, তাই যেকোনো সময় দেখতে পারবেন।" },
              { q: "আসলেই ইনকাম করা সম্ভব?", a: "হ্যাঁ, আমরা Real Marketplace Experience এবং Practical Project Based Training দিয়ে থাকি। আমাদের লক্ষ্য হলো আপনাকে Income-Oriented Skills শেখানো যা বাস্তব বাজারে কাজে লাগে।" },
              { q: "রিফান্ড পলিসি কি?", a: "আমরা প্রথম ২টি ক্লাস ফ্রি ট্রায়াল দিচ্ছি। আপনি নিজেই দেখে নিতে পারেন কোর্সটি আপনার জন্য কিনা। সম্পূর্ণ কোর্স ফিতে আমাদের কোনো রিফান্ড পলিসি নেই।" },
              { q: "কোর্স শেষে কি সার্টিফিকেট দেওয়া হয়?", a: "হ্যাঁ, কোর্স সফলভাবে সম্পন্ন করলে আপনি Plickify Academy থেকে একটি সার্টিফিকেট পাবেন।" },
            ].map((faq, i) => (
              <AccordionItem key={i} value={`faq-${i}`} className="bg-card/30 border border-white/[0.06] rounded-xl px-6 data-[state=open]:border-primary/20">
                <AccordionTrigger className="text-sm md:text-base font-medium hover:no-underline">{faq.q}</AccordionTrigger>
        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
            ...
            <p className="text-xs text-muted-foreground">
              ...
              <Link href="/auth" className="underline hover:text-primary transition-colors">
                Sign In
              </Link>
            </p>
          </div>
